...
2. Apply `migrations/postgres/001_initial.sql`, then each later numbered migration (including `002_ghost_revenue.sql` and `003_recovery_link_guard.sql`) with `psql`.
